...
from vinceworker.views import ingest_vulreport, send_daily_digest, generate_reminders, send_weekly_report, send_triage_cue
...
urlpatterns = [
    ...
    re_path(r"^triagecue/$", send_triage_cue, name="triagecue"),
]
