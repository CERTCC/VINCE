...
urlpatterns = [
    ...
    re_path('reports/weekly/(?P<pk>[0-9]+)/print/(?P<week>[0-9]+)/(?P<year>[0-9]+)/$', views.PrintWeeklyReportsView.as_view(), name='printweeklyreport'),
    ...
    re_path('contact/vcuser/(?P<pk>[0-9]+)/bounces/$', views.VinceCommUserBouncesView.as_view(), name='vcuserbouncestab'),
    ...
    re_path('^case/(?P<pk>[0-9]+)/noticketorcr/$', views.CaseNoTicketOrReportView.as_view(), name='casenoticketorreporttab'),
