...
$(function () {
    ...
    $(document).on("click", "#dt_start", function(event) {
	event.preventDefault();
	auto_display=false;
	dt_start();
    });

    $(document).on("click", "#finishcalc", function(event) {
        event.preventDefault();
	console.log("in finish calc");
    ...
    $(document).on("click", "#download_ssvc", function(event) {
        event.preventDefault();
        export_vul(false, true);
    });

    $(document).on("click", "#mwb_question", function(event) {
        event.preventDefault();
	$('#mwb_addon').show();
    });

    $(document).on("click", "#mwb_escape", function(event) {
	event.preventDefault();
        $('.tescape').hide();
    });

    $(document).on("click", "#public_escape", function(event) {
	event.preventDefault();
        $('.tescape').hide();
    });

    $(document).on("click", "#public_question", function(event) {
	event.preventDefault();
	$('#public_well_being_addon').show();
    });
    
    
    if (document.getElementById('ssvc_file')) {
	var data = JSON.parse(document.getElementById('ssvc_file').textContent);
	$('#something').jsonViewer(data, {collapsed: false, withQuotes: true, withLinks: false});
	setTimeout(() => {  process();
			 }, 2000);
...
var raw = [
    ...
    {name:"Automatable:none",id:1,children:[],parent:"Exploitation",props:"{}"},
    {name:"Automatable:poc",id:2,children:[],parent:"Exploitation",props:"{}"},
    {name:"Automatable:active",id:3,children:[],parent:"Exploitation",props:"{}"},
    {name:"Technical Impact:none:no",id:4,children:[],parent:"Automatable:none",props:"{}"},
    {name:"Technical Impact:none:yes",id:5,children:[],parent:"Automatable:none",props:"{}"},
    {name:"Technical Impact:poc:no",id:6,children:[],parent:"Automatable:poc",props:"{}"},
    {name:"Technical Impact:poc:yes",id:7,children:[],parent:"Automatable:poc",props:"{}"},
    {name:"Technical Impact:active:no",id:8,children:[],parent:"Automatable:active",props:"{}"},
    {name:"Technical Impact:active:yes",id:9,children:[],parent:"Automatable:active",props:"{}"},
    {"name":"Mission & Well-being:none:no:partial","id":11,"children":[],"parent":"Technical Impact:none:no",props:"{}"},{"name":"Mission & Well-being:none:no:total","id":12,"children":[],"parent":"Technical Impact:none:no",props:"{}"},{"name":"Mission & Well-being:none:yes:partial","id":13,"children":[],"parent":"Technical Impact:none:yes",props:"{}"},{"name":"Mission & Well-being:none:yes:total","id":14,"children":[],"parent":"Technical Impact:none:yes",props:"{}"},{"name":"Mission & Well-being:poc:no:partial","id":15,"children":[],"parent":"Technical Impact:poc:no",props:"{}"},{"name":"Mission & Well-being:poc:no:total","id":16,"children":[],"parent":"Technical Impact:poc:no",props:"{}"},{"name":"Mission & Well-being:poc:yes:partial","id":17,"children":[],"parent":"Technical Impact:poc:yes",props:"{}"},{"name":"Mission & Well-being:poc:yes:total","id":18,"children":[],"parent":"Technical Impact:poc:yes",props:"{}"},{"name":"Mission & Well-being:active:no:partial","id":19,"children":[],"parent":"Technical Impact:active:no",props:"{}"},{"name":"Mission & Well-being:active:no:total","id":20,"children":[],"parent":"Technical Impact:active:no",props:"{}"},{"name":"Mission & Well-being:active:yes:partial","id":21,"children":[],"parent":"Technical Impact:active:yes",props:"{}"},{"name":"Mission & Well-being:active:yes:total","id":22,"children":[],"parent":"Technical Impact:active:yes",props:"{}"},
    {"name":"Track:none:no:partial:low","id":24,"children":[],"parent":"Mission & Well-being:none:no:partial",props:"{}"},
    {"name":"Track:none:no:partial:medium","id":25,"children":[],"parent":"Mission & Well-being:none:no:partial",props:"{}"},
    {"name":"Track:none:no:partial:high","id":26,"children":[],"parent":"Mission & Well-being:none:no:partial",props:"{}"},
    {"name":"Track:none:no:total:low","id":27,"children":[],"parent":"Mission & Well-being:none:no:total",props:"{}"},
    {"name":"Track:none:no:total:medium","id":28,"children":[],"parent":"Mission & Well-being:none:no:total",props:"{}"},
    {"name":"Track*:none:no:total:high","id":29,"children":[],"parent":"Mission & Well-being:none:no:total",props:"{}"},
    {"name":"Track:none:yes:partial:low","id":30,"children":[],"parent":"Mission & Well-being:none:yes:partial",props:"{}"},
    {"name":"Track:none:yes:partial:medium","id":31,"children":[],"parent":"Mission & Well-being:none:yes:partial",props:"{}"},
    {"name":"Attend:none:yes:partial:high","id":32,"children":[],"parent":"Mission & Well-being:none:yes:partial",props:"{}"},
    {"name":"Track:none:yes:total:low","id":33,"children":[],"parent":"Mission & Well-being:none:yes:total",props:"{}"},
    {"name":"Track:none:yes:total:medium","id":34,"children":[],"parent":"Mission & Well-being:none:yes:total",props:"{}"},
    {"name":"Attend:none:yes:total:high","id":35,"children":[],"parent":"Mission & Well-being:none:yes:total",props:"{}"},
    {"name":"Track:poc:no:partial:low","id":36,"children":[],"parent":"Mission & Well-being:poc:no:partial",props:"{}"},
    {"name":"Track:poc:no:partial:medium","id":37,"children":[],"parent":"Mission & Well-being:poc:no:partial",props:"{}"},
    {"name":"Track*:poc:no:partial:high","id":38,"children":[],"parent":"Mission & Well-being:poc:no:partial",props:"{}"},
    {"name":"Track:poc:no:total:low","id":39,"children":[],"parent":"Mission & Well-being:poc:no:total",props:"{}"},
    {"name":"Track*:poc:no:total:medium","id":40,"children":[],"parent":"Mission & Well-being:poc:no:total",props:"{}"},
    {"name":"Attend:poc:no:total:high","id":41,"children":[],"parent":"Mission & Well-being:poc:no:total",props:"{}"},
    {"name":"Track:poc:yes:partial:low","id":42,"children":[],"parent":"Mission & Well-being:poc:yes:partial",props:"{}"},
    {"name":"Track:poc:yes:partial:medium","id":43,"children":[],"parent":"Mission & Well-being:poc:yes:partial",props:"{}"},
    {"name":"Attend:poc:yes:partial:high","id":44,"children":[],"parent":"Mission & Well-being:poc:yes:partial",props:"{}"},
    {"name":"Track:poc:yes:total:low","id":45,"children":[],"parent":"Mission & Well-being:poc:yes:total",props:"{}"},
    {"name":"Track*:poc:yes:total:medium","id":46,"children":[],"parent":"Mission & Well-being:poc:yes:total",props:"{}"},
    {"name":"Attend:poc:yes:total:high","id":47,"children":[],"parent":"Mission & Well-being:poc:yes:total",props:"{}"},
    {"name":"Track:active:no:partial:low","id":48,"children":[],"parent":"Mission & Well-being:active:no:partial",props:"{}"},
    {"name":"Track:active:no:partial:medium","id":49,"children":[],"parent":"Mission & Well-being:active:no:partial",props:"{}"},
    {"name":"Attend:active:no:partial:high","id":50,"children":[],"parent":"Mission & Well-being:active:no:partial",props:"{}"},
    {"name":"Track:active:no:total:low","id":51,"children":[],"parent":"Mission & Well-being:active:no:total",props:"{}"},
    {"name":"Attend:active:no:total:medium","id":52,"children":[],"parent":"Mission & Well-being:active:no:total",props:"{}"},
    {"name":"Act:active:no:total:high","id":53,"children":[],"parent":"Mission & Well-being:active:no:total",props:"{}"},
    {"name":"Attend:active:yes:partial:low","id":54,"children":[],"parent":"Mission & Well-being:active:yes:partial",props:"{}"},
    {"name":"Attend:active:yes:partial:medium","id":55,"children":[],"parent":"Mission & Well-being:active:yes:partial",props:"{}"},
    {"name":"Act:active:yes:partial:high","id":56,"children":[],"parent":"Mission & Well-being:active:yes:partial",props:"{}"},
    {"name":"Attend:active:yes:total:low","id":57,"children":[],"parent":"Mission & Well-being:active:yes:total",props:"{}"},
    {"name":"Act:active:yes:total:medium","id":58,"children":[],"parent":"Mission & Well-being:active:yes:total",props:"{}"},
    {"name":"Act:active:yes:total:high","id":59,"children":[],"parent":"Mission & Well-being:active:yes:total",props:"{}"},
...
function export_vul(includetree, download) {
    var tstamp = new Date()
    var oexport = { timestamp: tstamp.toISOString(),
		    timestamp_epoch_ms: tstamp.getTime(),
		    role: "Coordinator",
		    id: $('#exportId').text() || "Unspecified",
		    version: "2.0"
		  }
    var labels = $('#graph svg g.node text').map((i,w) => $(w).html()).toArray()
    var vals = $('#graph svg g.pathlink text textPath.chosen').map((i,w) => $(w).html()).toArray()
    console.log(vals)
	...
	var data = JSON.stringify(oexport);
	var ptranslate = "translate(120,-150)"
	if(window.innerWidth <= 1000)
            ptranslate = "translate(30,-90) scale(0.4,0.4)"
	$("#graph svg").height(200);
	$("#ssvc_decision").show();
	$('#something').jsonViewer(oexport, {collapsed: false, withQuotes: true, withLinks: false});
	$("#delssvc").removeClass("hidden");
	var csrftoken = getCookie('csrftoken');
	$.ajax({
            url: $("#something").attr("action"),
            type: "POST",
...
function download_vul(include_tree) {
...
function process() {
    ...
    var steps = ['Exploit','Automatable','Technical', 'Mission'];
    var lookfor = ['"Exploitation"', '"Automatable"', '"Technical Impact"', '"Mission & Well-being"'];
    var stimes = [1600,3200,5100]
    //console.log(new Date().getTime())
    var next_index = -1;
    var step_index = 0;
    $('.json-string').each(function(index) {
	if (lookfor.includes($( this ).text())) {
	    next_index = index + 1;
	    console.log("next_index is " + next_index);
	}
	if (next_index == index) {
	    var sptext = $(this).text();
	    clickprocess(steps[step_index], sptext.substring(1, sptext.length-1), stimes[step_index])
	    if (steps[step_index] == "Mission") {
		setTimeout(function() {
		    $('circle[nameid="'+sptext.substring(1, sptext.length-1)+'"]').parent().simClick()
		    $('#wsdiv').fadeOut('slow')
		    console.log("trying sim");
		    if (!auto_display) {
			$('#mwb').foundation('close');
		    }
		    var ptranslate = "translate(120,-150)"
...
function clickprocess(tstep,data,stime) {
    setTimeout(function() {
	//console.log(tstep)
	//console.log(stime)
	//console.log(new Date().getTime())
	console.log(data);
	if($(".prechk-"+data.toLowerCase()).length == 1) {
	    $(".prechk-"+data.toLowerCase()).simClick()
	} else {
...
function parse_file(xraw) {
    ...
    */
    ...
    /* (6)[["Row", "Exploitation", "Automatable", "Technical", "Mission_Well-being", "Decision"]] */
    //var yraw = [[],[],[],[],[]]
...
function showdiv(d) {
	...
	$('#mpopup').css({left:(iconPos.right) + "px",
			  top:(window.scrollY + iconPos.top + 5) + "px",
			  display:"block"})
