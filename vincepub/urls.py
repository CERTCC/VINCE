...
urlpatterns = [
    ...
    re_path(
        "^html/search/?$", RedirectView.as_view(pattern_name="vincepub:search", query_string=True, permanent=True)
    ),
    ...
    path("govreport/", views.GovReportView.as_view(), name="govreport"),
    #    path('vendorstatement/', views.VendorStmtView.as_view(), name='vendorstmt'),
    path("vulcoordrequest/", views.VulCoordRequestView.as_view(), name="vulcoordrequest"),
    #    url(r'^searchresults/$', views.searchResultView, name='searchresults'),
    ...
    re_path("^guidance/$", views.DisclosureGuidanceView.as_view(), name="discguidance"),
